...
import { authenticateUser, authenticateTutor, authenticateAffiliate, } from "../middleware/authentication.js";
import { createCourse, updateCourse, fetchAllCoursesUser, fetchSingleCourseUser, fetchAllCoursesTutor, fetchSingleCourseTutor, fetchAllCoursesAffiliate, fetchSingleCourseAffiliate, } from "../controllers/courseController.js"; // Adjust the import path
