...
import { authenticateTutor, authenticateAffiliate, } from "../middleware/authentication.js";
import { createShortLink, getShortLink, getAllPromotedCourses, getTutorAffiliateCourses, } from "../controllers/shortLinkController.js";
router
    .route("/:courseId")
