...
const updateAffiliateProfile = async (req, res) => {
    try {
        ...
        affiliate.isProfileComplete = !!(firstName &&
            lastName &&
...
const currentAffiliate = async (req, res) => {
    try {
...
const verifyResetPasswordToken = async (req, res) => {
    try {
        ...
        if (affiliate.resetToken === createHash(verificationToken) &&
...
const fetchAllAffiliates = async (req, res) => {
    try {
    }
    catch (error) {
...
const fetchSingleAffiliate = async (req, res) => {
    try {
...
export { updateAffiliateProfile, currentAffiliate, forgotPassword, verifyResetPasswordToken, resetPassword, resendToken, changePassword, dashboardData, fetchAllAffiliates, };
