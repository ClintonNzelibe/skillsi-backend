...
const createReview = async (req, res) => {
    try {
        ...
        if (course) {
            ...
            course.rating = parseFloat((course.totalRating / course.totalUserRated).toFixed(1));
            await course.save();
        }
        res
...
export { createReview, getUserReviews, getTutorReviews, updateReview, deleteReview, updateReviewStatus, };
