...
import { createHash, createTokenAffiliate, createAffiliateJWT, sendVerificationEmail, } from "../utils/index.js";
import { PasswordValidation, TokenGenerator } from "../helpers/index.js";
const signupAffiliate = async (req, res) => {
    try {
...
const verifyEmail = async (req, res) => {
    try {
        ...
        if (affiliate.verificationToken !== createHash(verificationToken) ||
...
const signinAffiliate = async (req, res) => {
    try {
        ...
        const tokenaffiliate = createTokenAffiliate({
